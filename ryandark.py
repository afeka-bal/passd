...
def logo():
    ...
    print('''
            ...
            "P    .zcccc,   z$P".,uu.`"?h.
                 z$$???MM= `?",dMMMMMMMx ".
              . d$P"xdMMbmn,.`4MMMMMMMMMb."
             d",$" dMMMMMMMMMx )MMMMMMMMMb
            d$r<$ MMMMMMMMMMMMb 4P44MMMMMMM
            $$F<$ MMMMMMMMMMMMMx    `MMMMM"
            ?$L L MMMMMMMMP"""4M,    MMMM",cc,
            `$$ $ 4MMMMMMM>      \  _PP" z$$$$c
             `$c`h 4MMMMMMM,     ,'`  cc$$""?$$$c
              `?c = "4MMMMMMn.  /     d$$$$ ?$$$$.
                `".,. "????""",c$ccd""""""",d$$$$h
...
8800Yb    db    .dP"Y8 .dP"Y8 8888b.  8888b.   dP"Yb  .dP"Y8
88__dP   dPYb   `Ybo." `Ybo."  8I  Yb  8I  Yb dP   Yb `Ybo."
88000   dP__Yb  o.`Y8b o.`Y8b  8I  dY  8I  dY Yb   dP o.`Y8b
